...
export default class ModelCreateInputGenerator extends ModelInputObjectTypeGenerator {
     ...
     * @param generators
     */
    static generateRelationFieldForInputType(model: IGQLType, field: IGQLField, generators: IGenerators): GraphQLInputObjectType | import("graphql/type/definition").GraphQLNonNull<GraphQLInputObjectType> | null;
    ...
    protected generateRelationFieldType(model: IGQLType, args: {}, field: IGQLField): GraphQLInputObjectType | import("graphql/type/definition").GraphQLNonNull<GraphQLInputObjectType> | null;
