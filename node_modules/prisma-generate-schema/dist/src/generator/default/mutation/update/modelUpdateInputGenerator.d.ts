...
export default class ModelUpdateInputGenerator extends RelatedModelInputObjectTypeGenerator {
     ...
     * @param generators
     */
    static generateRelationFieldForInputType(model: IGQLType, field: IGQLField, generators: IGenerators): import("graphql/type/definition").GraphQLInputObjectType | null;
    ...
    protected generateRelationFieldType(model: IGQLType, args: RelatedGeneratorArgs, field: IGQLField): import("graphql/type/definition").GraphQLInputObjectType | null;
}
