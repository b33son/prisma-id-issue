...
var ModelWhereInputGenerator = /** @class */ (function (_super) {
    ...
    ModelWhereInputGenerator.prototype.generateFields = function (model, args) {
        ...
        var recursiveFilter = ModelWhereInputGenerator.generateFiltersForSuffix(['AND', 'OR', 'NOT'], null, this.generators.scalarTypeGenerator.wrapList(this.generate(model, {})));
