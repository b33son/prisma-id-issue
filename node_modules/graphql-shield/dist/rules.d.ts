import { IRule, IFragment, IRuleConstructorOptions, ILogicRule, ShieldRule, IRuleResult, IOptions } from './types';
export declare class Rule implements IRule {
    readonly name: string;
    private cache;
    private fragment;
    private func;
    constructor(name: any, func: any, constructorOptions: IRuleConstructorOptions);
    /**
     *
     * @param parent
     * @param args
