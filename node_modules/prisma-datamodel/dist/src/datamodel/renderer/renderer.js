...
var Renderer = /** @class */ (function () {
    ...
    Renderer.prototype.render = function (input) {
        var _this = this;
        return input.types.map(function (t) {
            if (t.isEnum) {
    ...
    Renderer.prototype.renderType = function (type) {
        ...
        var renderedFields = type.fields.map(function (x) { return _this.renderField(x); });
    ...
    Renderer.prototype.renderComments = function (type, spacing) {
        var renderedComments = type.comments !== undefined ? type.comments.map(function (x) { return spacing + "// " + x.text; }).join('\n') : [];
    ...
    Renderer.prototype.renderDirectives = function (directives) {
        var _this = this;
        return this.mergeDirectives(directives).map(function (x) { return _this.renderDirective(x); }).join(" ");
    };
